    ...
    return (
        <main className="main-content">
            <section className="hero">
                <span className="eyebrow">Public Software Mirrors</span>
                <h1>Spaceport Mirrors</h1>
                <p className="subtitle">
                    Fast, free, and reliable mirrors for popular software distributions.
                    Hosted on Cloudflare R2 with zero egress fees.
                </p>
            </section>
                ...
                <div className="mirrors-grid">
                    <a href="/gradle/" className="mirror-card">
                        ...
                        <p>
                            ...
                            gradle-0.7-bin.zip to the latest release.
                        </p>
